...
var PhotoPermalink = {
    ...
    init: function() {
        ...
        this.pageHandlers.push(Event.listen(this.stageWrapper, "click", this.stageClickListener.bind(this)), Event.listen(this.stageWrapper, "dragstart", this.killDrag.bind(this)), Event.listen(this.stageWrapper, "selectstart", this.killDrag.bind(this)), Event.listen(this.buttonActions, "click", this.buttonListener.bind(this)), Event.listen(this.feedback, "click", function(event) {
    ...
    rotate: function(b) {
        ...
        this.setLoadingState(PhotoPermalink.STATE_IMAGE_DATA, true);
        CSS.hide(this.image);
        (new AsyncRequest("/ajax/photos/photo/rotate/")).setMethod("POST").setAllowCrossPageTransition(true).setReadOnly(false).setData(a).setHandler(this.storeResponseForRotate.bind(this, c)).send();
    },
...
var PhotoCropper = {
    ...
    start: function() {
        ...
        var c = copy_properties({
            ...
            owner: b.owner,
            id: this.options.uid,
            "return": "profile.php?id=" + this.options.uid,
...
TagTypeaheadView.prototype = {
    buildMarkup: function(b) {
        ...
        var a = this.parent.buildMarkup(b);
...
function NUXTestSearchTypeaheadView(a, b) {
    this.parent.construct(this, a, b);
}

Class.extend(NUXTestSearchTypeaheadView, "SearchTypeaheadView");

NUXTestSearchTypeaheadView.prototype = {
    render: function(e, b, c) {
        var d = _tx("Essayez l’outil de recherche d’amis");
        var a = '<span class="seeMore">' + d + '<span class="arrow"></span></span>';
        b.push({
            uid: "find-friends-nux-test",
            text: d,
            type: "calltoaction",
            path: URI("/find-friends/") + "",
            markup: a
        });
        return this.parent.render(e, b, c);
    }
};
